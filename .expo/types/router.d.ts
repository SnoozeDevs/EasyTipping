...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/dashboard` | `/dashboard` | `/(tabs)/fixtures` | `/fixtures` | `/(tabs)/ladder` | `/ladder` | `/(tabs)/tip` | `/tip` | `/login/` | `/login/login.styles` | `/modal` | `/signup/` | `/signup/signup.styles` | `/utils/constants`;
  // prettier-ignore
